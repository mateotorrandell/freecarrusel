...
/**
 * `gridClassName` lets the caller pick the column count: viewport breakpoints
 * lie when the gallery lives inside a narrow side panel.
 */
export function TemplateGallery({
  ...
  return (
    <div className={`oc-stagger grid gap-4 ${gridClassName}`}>
